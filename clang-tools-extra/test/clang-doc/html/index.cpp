...
// CHECK-HTML-NEXT:                            <pre><code id="{{([0-9A-F]{40})}}" class="code-clang-doc"><span class="k">namespace</span> <span class="nf">GlobalNamespace</span></code></pre>
// CHECK-HTML-NEXT:                        </a>
// CHECK-HTML-NEXT:                    </div>
// CHECK-HTML-NEXT:                    <div>
// CHECK-HTML-NEXT:                        <a href="inner/index.html">
// CHECK-HTML-NEXT:                            <pre><code id="{{([0-9A-F]{40})}}" class="code-clang-doc"><span class="k">namespace</span> <span class="nf">inner</span></code></pre>
// CHECK-HTML-NEXT:                        </a>
// CHECK-HTML-NEXT:                    </div>
