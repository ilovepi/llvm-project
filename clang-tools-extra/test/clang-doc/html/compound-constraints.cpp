...
// CHECK-HTML-NEXT:         <div>
// CHECK-HTML-NEXT:             <pre><code class="code-clang-doc"><span class="k">template</span> &lt;typename T&gt; <span class="nf">Incrementable</span> requires (T a) { a++; }</code></pre>
// CHECK-HTML-NEXT:         </div>
...
// CHECK-HTML-NEXT:     <div id="{{([0-9A-F]{40})}}" class="delimiter-container">
// CHECK-HTML-NEXT:         <div>
// CHECK-HTML-NEXT:             <pre><code class="code-clang-doc"><span class="k">template</span> &lt;typename T&gt; <span class="nf">Decrementable</span> requires (T a) { a--; }</code></pre>
// CHECK-HTML-NEXT:         </div>
// CHECK-HTML-NEXT:         <div class="nested-delimiter-container">
...
// CHECK-HTML-NEXT:     <div id="{{([0-9A-F]{40})}}" class="delimiter-container">
// CHECK-HTML-NEXT:         <div>
// CHECK-HTML-NEXT:             <pre><code class="code-clang-doc"><span class="k">template</span> &lt;typename T&gt; <span class="nf">PreIncrementable</span> requires (T a) { ++a; }</code></pre>
// CHECK-HTML-NEXT:         </div>
// CHECK-HTML-NEXT:         <div class="nested-delimiter-container">
...
// CHECK-HTML-NEXT:     <div id="{{([0-9A-F]{40})}}" class="delimiter-container">
// CHECK-HTML-NEXT:         <div>
// CHECK-HTML-NEXT:             <pre><code class="code-clang-doc"><span class="k">template</span> &lt;typename T&gt; <span class="nf">PreDecrementable</span> requires (T a) { --a; }</code></pre>
// CHECK-HTML-NEXT:         </div>
// CHECK-HTML-NEXT:         <div class="nested-delimiter-container">
